...
fn test_trim_undefined_removes_null_fields() {
    ...
    assert!(!user.contains_key("role"), "null field 'role' was not removed");
    assert!(!user.contains_key("after_undefined"), "null field 'after_undefined' was not removed");
...
fn test_trim_undefined_recursively_removes_nested_nulls() {
    ...
    assert!(!outer.contains_key("extra"), "Top-level null 'extra' was not removed");
    ...
    assert!(!inner_obj.contains_key("nested_null"), 
